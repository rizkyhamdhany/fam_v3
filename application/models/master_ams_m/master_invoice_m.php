...
class Master_invoice_m extends CI_Model {
    public function getIdMax(){
		...
		$sql="SELECT count(*) as count from amsparinvoice where kodegroup='$kode'";
		$query=$this->db->query($sql);
		return $query->result();
	}
         function getGrupAset(){
