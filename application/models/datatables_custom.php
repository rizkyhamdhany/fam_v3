...
//16				($i===0) ? $this->db->like($item, $_POST['search']['value']) : $this->db->or_like($item, $_POST['search']['value']);
            $column[$i] = $item;
            $i++;
        }
    ...
    function get_datatables($s_Table = null, $s_column = array(), $s_order = array(), $s_where = array(), $s_like = array()
