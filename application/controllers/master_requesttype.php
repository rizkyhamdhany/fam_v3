...
class master_requesttype extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('master_requesttype_m');
    ...
    function home() {
        ...
        $menuId = $this->home_m->get_menu_id('master_requesttype/home');
        ...
        if ($act==1) {
            ...
            $this->template->load('template/template_dataTable', 'master_requesttype_v', $data);
        }
    } else {
      $data['multilevel'] = $this->user_m->get_data(0, $this->session->userdata('usergroup'));
            $data['menu_all'] = $this->user_m->get_menu_all(0);
...
//        print_r($requestData);die();
    ...
    public function ajax_UpdateCategory(){
        ...
        if(element('ReqTypeID',$i_list)=="Generate"){
        $model = $this->global_m->simpan('Mst_RequestType', $data);
