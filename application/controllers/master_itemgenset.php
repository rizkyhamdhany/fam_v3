...
class master_itemgenset extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('master_itemgenset_m');
    ...
    function home() {
        ...
        $menuId = $this->home_m->get_menu_id('master_itemgenset/home');
        ...
        if ($act==1) {
            ...
            $this->template->set('title', 'Item Genset');
            $this->template->load('template/template_dataTable', 'master_itemgenset_v', $data);
        }
    } else {
      $data['multilevel'] = $this->user_m->get_data(0, $this->session->userdata('usergroup'));
            $data['menu_all'] = $this->user_m->get_menu_all(0);
...
//        print_r($requestData);die();
        ...
        $sql = "SELECT a.IClassID,a.ItemTypeID,a.ItemID,a.ItemName,a.VendorID,a.Image,b.IClassName,
                                c.ItemTypeName, a.Is_trash,d.NamaCompany,a.Id_company,
                                a.Gst_Desc,a.Gst_Pelaksana,a.Gst_SerialNumber,a.Knd_Merk,a.Knd_ThnPmbtn, a.Status
                                FROM Mst_ItemListAP a INNER JOIN Mst_ItemClass b ON a.IClassID=b.IClassID 
                                INNER JOIN Mst_ItemType c ON a.ItemTypeID=c.ItemTypeID LEFT JOIN Mst_Company d ON a.Id_company = d.IdCompany where a.Status like '%".$iStatus."%'";            
        ...
        if (!empty($requestData['search']['value'])) {
            if ($iSearch=='1'){
                $sql = "SELECT a.IClassID,a.ItemTypeID,a.ItemID,a.ItemName,a.VendorID,a.Image,b.IClassName,
                                ...
                                a.Gst_Desc,a.Gst_Pelaksana,a.Gst_SerialNumber,a.Knd_Merk,a.Knd_ThnPmbtn, a.Status
                                FROM Mst_ItemListAP a INNER JOIN Mst_ItemClass b ON a.IClassID=b.IClassID 
                                INNER JOIN Mst_ItemType c ON a.ItemTypeID=c.ItemTypeID LEFT JOIN Mst_Company d ON a.Id_company = d.IdCompany where a.Status like '%".$iStatus."%'and ItemID like '%".$requestData['search']['value']."%'";
            }else if ($iSearch=='2'){
                $sql = "SELECT a.IClassID,a.ItemTypeID,a.ItemID,a.ItemName,a.VendorID,a.Image,b.IClassName,
                                c.ItemTypeName, a.Is_trash,d.NamaCompany,a.Id_company,
                                a.Gst_Desc,a.Gst_Pelaksana,a.Gst_SerialNumber,a.Knd_Merk,a.Knd_ThnPmbtn, a.Status
                                FROM Mst_ItemListAP a INNER JOIN Mst_ItemClass b ON a.IClassID=b.IClassID 
                                INNER JOIN Mst_ItemType c ON a.ItemTypeID=c.ItemTypeID LEFT JOIN Mst_Company d ON a.Id_company = d.IdCompany where a.Status like '%".$iStatus."%'and Image like '%".$requestData['search']['value']."%'";
            }else if ($iSearch=='3'){
                $sql = "SELECT a.IClassID,a.ItemTypeID,a.ItemID,a.ItemName,a.VendorID,a.Image,b.IClassName,
                                c.ItemTypeName, a.Is_trash,d.NamaCompany,a.Id_company,
                                a.Gst_Desc,a.Gst_Pelaksana,a.Gst_SerialNumber,a.Knd_Merk,a.Knd_ThnPmbtn, a.Status
                                FROM Mst_ItemListAP a INNER JOIN Mst_ItemClass b ON a.IClassID=b.IClassID 
                                INNER JOIN Mst_ItemType c ON a.ItemTypeID=c.ItemTypeID LEFT JOIN Mst_Company d ON a.Id_company = d.IdCompany where a.Status like '%".$iStatus."%'and IClassName like '%".$requestData['search']['value']."%'";
            }else if ($iSearch=='4'){
                $sql = "SELECT a.IClassID,a.ItemTypeID,a.ItemID,a.ItemName,a.VendorID,a.Image,b.IClassName,
                                c.ItemTypeName, a.Is_trash,d.NamaCompany,a.Id_company,
                                a.Gst_Desc,a.Gst_Pelaksana,a.Gst_SerialNumber,a.Knd_Merk,a.Knd_ThnPmbtn, a.Status
                                FROM Mst_ItemListAP a INNER JOIN Mst_ItemClass b ON a.IClassID=b.IClassID 
                                INNER JOIN Mst_ItemType c ON a.ItemTypeID=c.ItemTypeID LEFT JOIN Mst_Company d ON a.Id_company = d.IdCompany where a.Status like '%".$iStatus."%'and ItemTypeName like '%".$requestData['search']['value']."%'";
            }else if ($iSearch=='5'){
                $sql = "SELECT a.IClassID,a.ItemTypeID,a.ItemID,a.ItemName,a.VendorID,a.Image,b.IClassName,
                                c.ItemTypeName, a.Is_trash,d.NamaCompany,a.Id_company,
                                a.Gst_Desc,a.Gst_Pelaksana,a.Gst_SerialNumber,a.Knd_Merk,a.Knd_ThnPmbtn, a.Status
                                FROM Mst_ItemListAP a INNER JOIN Mst_ItemClass b ON a.IClassID=b.IClassID 
                                INNER JOIN Mst_ItemType c ON a.ItemTypeID=c.ItemTypeID LEFT JOIN Mst_Company d ON a.Id_company = d.IdCompany where a.Status like '%".$iStatus."%'and ItemName like '%".$requestData['search']['value']."%'";
            }else if ($iSearch=='6'){
                $sql = "SELECT a.IClassID,a.ItemTypeID,a.ItemID,a.ItemName,a.VendorID,a.Image,b.IClassName,
                                c.ItemTypeName, a.Is_trash,d.NamaCompany,a.Id_company,
                                a.Gst_Desc,a.Gst_Pelaksana,a.Gst_SerialNumber,a.Knd_Merk,a.Knd_ThnPmbtn, a.Status
                                FROM Mst_ItemListAP a INNER JOIN Mst_ItemClass b ON a.IClassID=b.IClassID 
                                INNER JOIN Mst_ItemType c ON a.ItemTypeID=c.ItemTypeID LEFT JOIN Mst_Company d ON a.Id_company = d.IdCompany where a.Status like '%".$iStatus."%'and NamaCompany like '%".$requestData['search']['value']."%'";
            }else{
                $sql = "SELECT * from Mst_ItemListAP where Status like '%".$iStatus."%'"; 
                $sql .= "and ItemID like '%".$requestData['search']['value']."%'"; 
    ...
    public function ajax_UpdateStatusCategory(){
        ...
        $model = $this->global_m->ubah('Mst_ItemListAP', $data,'ItemID',$id);
        if ($model) {
            $notifikasi = Array(
                'msgType' => true,
                'msgTitle' => 'Success',
        ...
        $rows = $this->master_itemtype_m->getUserKab($prop);
        $options = "";
    ...
    public function ajax_UpdateCategory(){
        ...
        if(element('ItemID',$i_list)=="Generate"){
            $id = $this->master_itemgenset_m->getIdMax();
             $data = array(
            'ItemID' => $id,
            'IClassID' => $IClassID,
        ...
        if(element('ItemID',$i_list)=="Generate"){
        $model = $this->global_m->simpan('Mst_ItemListAP', $data);
       }else{
        $model = $this->global_m->ubah('Mst_ItemListAP', $data,'ItemID',$id);
       }
        if ($model) {
   ...
   public function getUserInfo() {
        $this->CI = & get_instance(); //and a.kcab_id<>'1100'
        $rows = $this->master_itemgenset_m->getUserInfo();
        $data['data'] = array();
        foreach ($rows as $row) {
