                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="tab_2_1">
                        <div class="scroller" style="height:400px; ">
                            ...
                            <div class="row">
                                 <div class="col-md-8">
                                    <a class="btn btn-sm btn-primary" href="#" id="btnAdd" data-toggle="modal" data-target="#mdl_Update">Add Master Cabang</a>
...
<div class="modal fade draggable-modal" id="mdl_Update" tabindex="-1" role="basic" aria-hidden="true">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label col-sm-3">Branch Alias</label>
            <div class="col-sm-7">
                <input type="text" class="form-control" id="txtBranchAlias">
            </div>
        </div>

       <div class="form-group">
                <label class="control-label col-md-3">Pilih Zonasi
                   </label>
                        <div class="col-md-7">
                            <select id="txtZoneID" required="required" class="form-control" type="text">
                                <option value="">--Pilih--</option>
                                    <?php foreach ($zonasi1 as $value) { ?>
...
<script>
    ...
    var iSearch='%';
     ...
     $("#txtBranchID").val("Generate"); 
     $("#txtBranchCode").val("");
     $("#txtBranchName").val(""); 
     $("#txtBranchAlias").val("");
     $("#txtZoneID").val("");

     document.getElementById("txtBranchCode").readOnly = false;
     document.getElementById("txtBranchName").readOnly = false;
     document.getElementById("txtBranchAlias").readOnly = false;
     document.getElementById("txtZoneID").readOnly = false;
 ...
 function statusAdd(e){
    ...
    $('#table_gridCategory').on('click', '#btnAktiv', function () {
        ...
        $.ajax({
          ...
          cache:false,
          dataType: "JSON",
      url: "<?php echo base_url("/master_cabang/ajax_UpdateStatusCategory"); ?>", // json datasource
   ...
   function clickUpdate(){
    var i_clsUpdate={
        ...
        BranchAlias: $("#txtBranchAlias").val(),
        ZoneID: $("#txtZoneID").val(),
    ...
    $.ajax({
      ...
      cache:false,
      dataType: "JSON",
      url: "<?php echo base_url("/master_cabang/ajax_UpdateCategory"); ?>", // json datasource
      data: { sTbl: i_clsUpdate },
      success: function (e) {
        console.log(e);
        if(e.msgType==true){
 ...
 $('#table_gridCategory').on('click', '#btnDetail', function () {
    ...
    var idata = dataTable.row(iclosestRow).data();
    // console.log(idata);
    $("#txtBranchID").val(idata[1]);
    $("#txtBranchCode").val(idata[2]);
    $("#txtBranchName").val(idata[3]);
    $("#txtBranchAlias").val(idata[4]);
    $("#txtZoneID").val(idata[5]);



    document.getElementById("txtBranchID").readOnly = true;
    document.getElementById("txtBranchCode").readOnly = true;
    document.getElementById("txtBranchName").readOnly = true;
    document.getElementById("txtBranchAlias").readOnly = true;
    document.getElementById("txtZoneID").readOnly = true;
  ...
  $('#table_gridCategory').on('click', '#btnUpdate', function () {
    ...
    document.getElementById("txtBranchID").readOnly = false;
    document.getElementById("txtBranchCode").readOnly = false;
    document.getElementById("txtBranchName").readOnly = false;
    document.getElementById("txtBranchAlias").readOnly = false;
    document.getElementById("txtZoneID").readOnly = false;
...
//                // set the initial value
            ...
            "serverSide": true,
            "ajax": {
                url: "<?php echo base_url("/master_cabang/get_server_side"); ?>", // json datasource
