                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="tab_2_1">
                        <div class="scroller" style="height:400px; ">
                            ...
                            <div class="row">
                                 <div class="col-md-8">
                                    <a class="btn btn-sm btn-primary" href="#" id="btnAdd" data-toggle="modal" data-target="#mdl_Update">Add Master Position</a>
...
<div class="modal fade draggable-modal" id="mdl_Update" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog  modal-lg">
      ...
      <div class="modal-body">
        ...
        <input style="display:none;" class="form-control" id="txtRaw_ID" >
         <div class="validator-form form-horizontal">
    <div class="form-group">
            <label class="control-label col-sm-3">Position ID</label>
            <div class="col-sm-7">
                <input type="text" class="form-control" id="txtPositionID">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control" id="txtPositionName">
            </div>
        </div>
...
<script>
    ...
    var iSearch='%';
     ...
     document.getElementById("txtPositionID").readOnly = false;
     document.getElementById("txtPositionName").readOnly = false;
 ...
 function statusAdd(e){
    ...
    $('#table_gridCategory').on('click', '#btnAktiv', function () {
        ...
        $.ajax({
          ...
          cache:false,
          dataType: "JSON",
      url: "<?php echo base_url("/master_position/ajax_UpdateStatusCategory"); ?>", // json datasource
   ...
   function clickUpdate(){
    ...
    $.ajax({
      ...
      cache:false,
      dataType: "JSON",
      url: "<?php echo base_url("/master_position/ajax_UpdateCategory"); ?>", // json datasource
      data: { sTbl: i_clsUpdate },
      success: function (e) {
        console.log(e);
        if(e.msgType==true){
 ...
 $('#table_gridCategory').on('click', '#btnDetail', function () {
    ...
    $("#txtPositionID").val(idata[2]);
    $("#txtPositionName").val(idata[3]);



    document.getElementById("txtPositionID").readOnly = true;
    document.getElementById("txtPositionName").readOnly = true;
  ...
  $('#table_gridCategory').on('click', '#btnUpdate', function () {
    ...
    document.getElementById("txtRaw_ID").readOnly = false;
    document.getElementById("txtPositionID").readOnly = false;
    document.getElementById("txtPositionName").readOnly = false;
...
//                // set the initial value
            ...
            "serverSide": true,
            "ajax": {
                url: "<?php echo base_url("/master_position/get_server_side"); ?>", // json datasource
