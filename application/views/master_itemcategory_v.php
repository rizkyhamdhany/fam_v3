    ...
    <div class="modal-dialog  modal-lg">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            <label class="control-label col-sm-3">Item Category Code</label>
            <div class="col-sm-7">
                <input type="text" class="form-control" id="txtCode">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-sm-3">Item Category Name</label>
            <div class="col-sm-7">
 ...
 function statusAdd(e){
    ...
    $('#table_gridCategory').on('click', '#btnAktiv', function () {
        ...
        $.ajax({
          ...
          cache:false,
          dataType: "JSON",
      url: "<?php echo base_url("/master_itemcategory/ajax_UpdateStatusCategory"); ?>", // json datasource
   ...
   function clickUpdate(){
    var i_clsUpdate={
        IClassID: $("#txtId").val(),
        ClassCode: $("#txtCode").val(),
        IClassName: $("#txtName").val(),
        Priod: $("#txtPeriod").val(),
        Status: iStatusAdd
    }
    ...
    $.ajax({
      ...
      cache:false,
      dataType: "JSON",
      url: "<?php echo base_url("/master_itemcategory/ajax_UpdateCategory"); ?>", // json datasource
      data: { sTbl: i_clsUpdate },
      success: function (e) {
        console.log(e);
        if(e.msgType==true){
...
//                // set the initial value
            ...
            "serverSide": true,
            "ajax": {
                url: "<?php echo base_url("/master_itemcategory/get_server_side"); ?>", // json datasource
