                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="tab_2_1">
                        <div class="scroller" style="height:400px; ">
                            ...
                            <div class="row">
                                 <div class="col-md-8">
                                    <a class="btn btn-sm btn-primary" href="#" id="btnAdd" data-toggle="modal" data-target="#mdl_Update">Add Item Genset</a>
    ...
    <div class="modal-dialog  modal-lg">
      ...
      <div class="modal-body">
            ...
            <label class="control-label col-sm-3">Category</label>
                <div class="col-sm-7">
                    <!--<input type="text" class="form-control" name="classid" requered/>-->
                     <select class="form-control " name="classid" id="classid"  onchange="OnClassItem(this.vaue);">
        ...
        <label class="control-label col-sm-3">Item Type</label>
            <div class="col-sm-7">
                <div id="loadItemType">
                <select class="form-control" name="item_typeid" id="item_typeid">
                    <option value="" >--Select--</option>
                 </select>
                </div>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <select class="form-control" name="perusahaanid" id="perusahaanid">
                     <option value="" >--Select--</option>
                     <?php foreach($item_selvendor as $row){ ?>
                        <option value="<?php echo $row->IdCompany; ?>"><?php echo $row->NamaCompany; ?></option>
                     <?php } ?>
                 </select>
            </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7">
                <textarea type="text" rows="4" class="form-control" name="deskripsi" id="deskripsi"></textarea>
            </div>
        </div>
          <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label col-sm-3">Merek</label>
            <div class="col-sm-7">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input type="file" id="gambar" name="gambar" class="form-control" size="40" required>
            </div>
        </div>
    ...
    $.ajax({
      ...
      alert(e.msgTitle);
       ...
       function OnClassItem(input) {
        $('#kabupatenkota').empty();
        $('#kecamatan').empty();
        $('#kecamatan').append("<option value='NULL'>-Pilih-</option>");
        var no = 0;
        $.ajax({
            type: "POST",
            dataType: "json",
            "url": "<?php echo base_url("master_itemgenset/OnClassItem/"); ?>/" + input, //<?php echo base_url() ?>+"kemitraanonline/getkota/"+input,//<?php echo base_url("referensi/daftar_vendor/getkabupaten/3") ?>, //
            data: input,
...
//                // set the initial value
            ...
            "serverSide": true,
            "ajax": {
                url: "<?php echo base_url("/master_itemgenset/get_server_side"); ?>", // json datasource
