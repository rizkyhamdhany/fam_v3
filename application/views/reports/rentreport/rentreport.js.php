<script>
    ...
    $("#fm_param").submit(function (e) {
        ...
        $('#id_downlod').attr('href', "<?php echo base_url() . 'reports/rentreport/downloadReport?' ?>" + $('form#fm_param').serialize());
    });
    ...
    function loadGridVendor() {
        ...
        table2.dataTable({
            "ajax": {
                "url": "<?php echo base_url("/reports/rentreport/ajax_GridVendor"); ?>",
                "type": "POST",
                "data": function (z) {
                    z.from = $('#from').val();
                    z.to = $('#to').val();
