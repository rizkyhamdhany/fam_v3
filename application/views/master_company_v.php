...
<div class="modal fade draggable-modal" id="mdl_Update" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog  modal-lg">
      ...
      <div class="modal-body">
        ...
        <input style="display:none;" class="form-control" id="txtReqTypeID" >
         <div class="validator-form form-horizontal">
    <div class="form-group">
            <label class="control-label col-sm-3">Kode Perusahaan</label>
            <div class="col-sm-7">
                <input type="text" class="form-control" id="txtReqTypeID">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control" id="txtReqTypeName">
            </div>
        </div>
...
<script>
    ...
    var iSearch='%';
     ...
     $("#txtReqTypeID").val("Generate"); 
     $("#txtReqTypeName").val("");
     $("#txtIs_trash").val("");
     
     document.getElementById("txtReqTypeID").readOnly = false;
 ...
 function statusAdd(e){
    ...
    $('#table_gridCategory').on('click', '#btnAktiv', function () {
        ...
        $.ajax({
          ...
          cache:false,
          dataType: "JSON",
      url: "<?php echo base_url("/master_requesttype/ajax_UpdateStatusCategory"); ?>", // json datasource
   ...
   function clickUpdate(){
    var i_clsUpdate={
        ReqTypeID: $("#txtReqTypeID").val(),
        ReqTypeName: $("#txtReqTypeName").val(),
        Is_trash: $("#txtIs_trash").val(),
        Status: iStatusAdd
    }
    ...
    $.ajax({
      ...
      cache:false,
      dataType: "JSON",
      url: "<?php echo base_url("/master_requesttype/ajax_UpdateCategory"); ?>", // json datasource
      data: { sTbl: i_clsUpdate },
      success: function (e) {
        console.log(e);
        if(e.msgType==true){
 ...
 $('#table_gridCategory').on('click', '#btnDetail', function () {
    ...
    var idata = dataTable.row(iclosestRow).data();
    // console.log(idata);
     $("#txtReqTypeID").val(idata[1]);
    $("#txtReqTypeName").val(idata[2]);
    $("#txtIs_trash").val(idata[3]);



    document.getElementById("txtReqTypeID").readOnly = true;
    document.getElementById("txtReqTypeName").readOnly = true;
  ...
  $('#table_gridCategory').on('click', '#btnUpdate', function () {
    ...
    document.getElementById("txtReqTypeID").readOnly = false;
    document.getElementById("txtReqTypeName").readOnly = false;
    document.getElementById("txtIs_trash").readOnly = false;
...
//                // set the initial value
            ...
            "serverSide": true,
            "ajax": {
                url: "<?php echo base_url("/master_requesttype/get_server_side"); ?>", // json datasource
