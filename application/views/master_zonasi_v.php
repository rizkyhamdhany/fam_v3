...
<div class="modal fade draggable-modal" id="mdl_Update" tabindex="-1" role="basic" aria-hidden="true">
    ...
    <div class="form-group">
            <label class="control-label col-sm-3">Zone ID</label>
            <div class="col-sm-7">
                <input type="text" class="form-control" id="txtZoneID">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control" id="txtZoneName">
            </div>
        </div>
...
<script>
    ...
    var iSearch='%';
     ...
     document.getElementById("txtZoneName").readOnly = false;
 ...
 function statusAdd(e){
    ...
    $('#table_gridCategory').on('click', '#btnAktiv', function () {
        ...
        $.ajax({
          ...
          cache:false,
          dataType: "JSON",
      url: "<?php echo base_url("/master_zonasi/ajax_UpdateStatusCategory"); ?>", // json datasource
   ...
   function clickUpdate(){
    ...
    $.ajax({
      ...
      cache:false,
      dataType: "JSON",
      url: "<?php echo base_url("/master_zonasi/ajax_UpdateCategory"); ?>", // json datasource
      data: { sTbl: i_clsUpdate },
      success: function (e) {
        console.log(e);
        if(e.msgType==true){
 ...
 $('#table_gridCategory').on('click', '#btnDetail', function () {
    ...
    $("#txtZoneID").val(idata[2]);
    $("#txtZoneName").val(idata[3]);



    document.getElementById("txtZoneID").readOnly = true;
    document.getElementById("txtZoneName").readOnly = true;
