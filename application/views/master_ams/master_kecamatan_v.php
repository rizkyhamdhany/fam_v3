                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab_2_2">
                        ...
                        <form role="form" method="post" class="form-horizontal cls_from_sec_user cls_form_validate "
                              action="<?php echo base_url('parameter/master_kecamatan/home'); ?>" id="idFormUser" novalidate="novalidate">    
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Kode Kecamatan
                                       
                                    </label>
                                    <div class="col-md-9">
                                        <input readonly="" id="id_kec"  name="kec" data-required="1" class="form-control input-sm" type="text"> 
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="control-label col-md-3">Pilih Kabupaten
                                    ...
                                    <div class="col-md-9">
                                       ...
                                       <div class="">
                                             ...
                                             <select id="id_kab" required="required" class="form-control" name="kab">
                                                
                                                <?php foreach ($kab as $value) { ?>
                                                <?php // print_r($value);die(); ?>
                                                    <option value="<?php echo $value->kodekabupaten ?>"><?php echo $value->namakabupaten ?></option>
                                                <?php } ?>
                                 ...
                                 <div class="form-group">
                                    <label class="control-label col-md-3">Nama Kecamatan
                                       
                                    </label>
                                    <div class="col-md-9">
                                        <input required id="id_namaKec"  name="namaKec" data-required="1" class="form-control input-sm" type="text"> 
                                    </div>
...
<script>
    ...
    var TableManaged = function () {
        ...
        var initTable1 = function () {
            ...
            // begin first table
            table.dataTable({
                "ajax": "<?php echo base_url("/parameter/master_kecamatan/getUserInfo"); ?>",
                "columns": [
                    { "data": "kodekecamatan" },
                    { "data": "namakecamatan" },
                    { "data": "kodekabupaten" },
...
//                var id_kyw = $(this).find("td").eq(5).html();
                  ...
                  $('#id_kab').val(kode_kab);
                $('#id_kec').val(kode_propinsi);
                $('#id_namaKec').val(nm_propinsi);
