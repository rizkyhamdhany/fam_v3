                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab_2_2">
                        ...
                        <form role="form" method="post" class="form-horizontal cls_from_sec_user cls_form_validate "
                              action="<?php echo base_url('parameter/master_kabupaten/home'); ?>" id="idFormUser" novalidate="novalidate">    
...
<script>
    ...
    var TableManaged = function () {
        ...
        var initTable1 = function () {
            ...
            // begin first table
            table.dataTable({
                "ajax": "<?php echo base_url("/parameter/master_kabupaten/getUserInfo"); ?>",
                "columns": [
                    { "data": "kodepropinsi" },
                    { "data": "namapropinsi" },
                    { "data": "kodekabupaten" },
