                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab_2_2">
                        ...
                        <form role="form" method="post" class="form-horizontal cls_from_sec_user cls_form_validate "
                              action="<?php echo base_url('parameter/master_propinsi/home'); ?>" id="idFormUser" novalidate="novalidate">    
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Kode Propinsi
                                       
                                    </label>
                                    <div class="col-md-9">
                                        <input  id="id_kodepropinsi"  name="id_kodepropinsi" data-required="1" class="form-control input-sm" type="text"> 
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="control-label col-md-3">Nama Propinsi
                                       
                                    </label>
                                    <div class="col-md-9">
                                        <input required id="id_namapropinsi"  name="id_namapropinsi" data-required="1" class="form-control input-sm" type="text"> 
                                    </div>
...
<script>
    ...
    var TableManaged = function () {
        ...
        var initTable1 = function () {
            ...
            // begin first table
            table.dataTable({
                "ajax": "<?php echo base_url("/parameter/master_propinsi/getUserInfo"); ?>",
                "columns": [
                    { "data": "KodePropinsi" },
                    { "data": "NamaPropinsi" }
                ],
