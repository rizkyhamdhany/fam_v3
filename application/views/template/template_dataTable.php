...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url('metronic/global/plugins/datatables/datatables.min.css'); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url('metronic/global/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css'); ?>" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo base_url('metronic/global/plugins/bootstrap-toastr/toastr.min.css'); ?>" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo base_url('metronic/layouts/layout4/css/layout.min.css'); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url('metronic/layouts/layout4/css/themes/light.min.css'); ?>" rel="stylesheet" type="text/css" id="style_color" />
        <link href="<?php echo base_url('metronic/layouts/layout4/css/custom.css'); ?>" rel="stylesheet" type="text/css" />
        <!-- END THEME LAYOUT STYLES -->
        <link rel="shortcut icon" href="<?php echo base_url('metronic/img/favicon.ico'); ?>" /> 

        <link href="<?php echo base_url('metronic/global/css/dataTables.checkboxes.css'); ?>" rel="stylesheet" type="text/css" />
