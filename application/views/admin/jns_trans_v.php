        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                ...
                <form role="form" method="post" class="cls_from_rumah"
                      action="<?php echo base_url('jns_trans/home'); ?>" id="id_formIntegrasi">
                    <div class="row">
...
<script>
    ...
    var TableManaged = function () {
        ...
        var initTableJurnal = function () {
            ...
            var table = $('#idTabelJurnal').dataTable({
                "ajax": "<?php echo base_url("/admin/jns_trans/getAllJurnal"); ?>",
                "columns": [
                    {"data": "id_jns_transaksi"},
                    {"data": "nama_jns_transaksi"},
                    {"data": "kode_perk"},
                    {"data": "nama_perk"},
                    {"data": "keterangan"}
                ],
    ...
    function ajaxSubmit() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>admin/jns_trans/simpan",
            data: dataString,
    ...
    function ajaxUbah() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>admin/jns_trans/ubah",
            data: dataString,
            success: function (data) {
                $('#id_ReloadJurnal').trigger('click');
                $('#id_btnBatal').trigger('click');
    ...
    function ajaxHapus() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>admin/jns_trans/hapus",
