...
function Header()
{
	$this->Image('metronic/img/logo_spr.jpg',8.5,0.5,3);
	$this->Ln(2.6);
	$this->SetFont('Times','',10);
	$this->Cell(19,0.1,'',0,0,'C');
	$this->SetFont('Times','',10);
	$this->Ln();
	$this->Cell(19,0.1,'',0,0,'C');
	$this->Ln();
	$this->Cell(19,0.4,'Site Project  : Jl H M Sanun, Kampung Sawah Cibinong 16914, Telp : 021.29208117 ',0,0,'C');
	$this->Ln(0.7);
	$this->SetFont('Times','',10);
	$this->Cell(19,0.01,'',1,0,'C');
	$this->Ln(0.5);
	/* Fungsi Line untuk membuat garis */
	//$this->Line(0.5,5,20.5,5);
	//$this->Line(0.5,5.20,20.5,5.20);
